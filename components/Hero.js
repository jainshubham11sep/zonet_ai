    ...
    <section className="relative min-h-[80vh] bg-background pt-32 pb-20 overflow-hidden flex flex-col items-center">
      <div className="container mx-auto px-6 flex flex-col items-center text-center relative z-10">
        ...
        <motion.div
          ...
          className="flex items-center gap-2 px-4 py-2 bg-card rounded-full border border-border-custom shadow-sm mb-10"
        >
          <div className="flex -space-x-1">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="w-4 h-4 rounded-full border-2 border-card bg-yellow-400" />
            ))}
          </div>
