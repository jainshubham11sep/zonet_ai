...
const AIWhatWeDoTabs = () => {
  return (
    <section className="bg-[#F7F6F3] px-4 sm:px-6 md:px-10 lg:px-12 pt-12 md:pt-14 pb-10 max-w-[1200px] mx-auto relative overflow-hidden">
      {/* Badge */}
      <SectionBadge className="mb-2">What We Do</SectionBadge>

      {/* Header Row */}
      <div className="flex justify-between items-start gap-6">
        <div className="flex-1">
          <h1 className="font-heading text-[26px] sm:text-[32px] md:text-[38px] font-bold leading-[1.18] text-[#1A1A1A] mb-[14px]">
            We don&apos;t just build products.
            <br />
            We turn them into{" "}
            <span className="text-[#686BAB]">intelligent systems.</span>
          </h1>
          <p className="text-sm text-[#686B6B] leading-[1.65] max-w-[460px]">
            Zonnetech combines design, engineering, and AI to deliver digital
            products that are fast, scalable, and future-ready.
          </p>
        </div>
        ...
        <div className="w-[220px] shrink-0 relative h-[140px] hidden lg:block">
          ...
          >
            ...
            <g opacity="0.6">
              <path
                d="M55 105 L105 90 L155 105 L105 120 Z"
                fill="#ECEAE4"
                stroke="#C4C0B8"
                strokeWidth="1"
              />
              <path
                d="M55 105 L55 118 L105 133 L105 120 Z"
                fill="#E4E1DA"
                stroke="#C4C0B8"
                strokeWidth="1"
              />
              <path
                d="M155 105 L155 118 L105 133 L105 120 Z"
                fill="#E8E5DF"
                stroke="#C4C0B8"
                strokeWidth="1"
              />
            ...
            <g opacity="0.78">
              <path
                d="M62 75 L105 62 L148 75 L105 88 Z"
                fill="#E6E3DC"
                stroke="#B8B4AC"
                strokeWidth="1"
              />
              <path
                d="M62 75 L62 87 L105 100 L105 88 Z"
                fill="#DEDAD2"
                stroke="#B8B4AC"
                strokeWidth="1"
              />
              <path
                d="M148 75 L148 87 L105 100 L105 88 Z"
                fill="#E2DED6"
                stroke="#B8B4AC"
                strokeWidth="1"
              />
            ...
            <g>
              <path
                d="M70 44 L105 33 L140 44 L105 55 Z"
                fill="#DAD6CE"
                stroke="#ADA9A0"
                strokeWidth="1.2"
              />
              <path
                d="M70 44 L70 56 L105 67 L105 55 Z"
                fill="#D0CCCA"
                stroke="#ADA9A0"
                strokeWidth="1.2"
              />
              <path
                d="M140 44 L140 56 L105 67 L105 55 Z"
                fill="#D8D4CC"
                stroke="#ADA9A0"
                strokeWidth="1.2"
              />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-9">
        ...
        <div className="bg-white border border-[#E6E4DF] rounded-[18px] pt-6 px-[22px] pb-5 relative transition-all duration-200 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:-translate-y-0.5">
          <div className="text-[10px] font-bold tracking-[.1em] text-[#1A1A1A] mb-[10px]">
            01. BUILD
          </div>
          ...
          <div className="font-heading text-[17px] font-semibold text-[#1A1A1A] leading-[1.3] mb-[14px]">
            Digital Products
            <br />
            That Scale
          </div>
          <ul className="flex flex-col gap-2">
            {[
              ...
              <li
                key={item}
                className="flex items-center gap-2 text-[13px] text-[#686B6B]"
              >
                <span className="w-[18px] h-[18px] rounded-full flex items-center justify-center shrink-0 text-[10px] bg-[#F7F6F3] text-[#1A1A1A]">
                  ✓
                </span>
                {item}
              </li>
        ...
        <div className="bg-white border border-[#E8C547] rounded-[18px] pt-6 px-[22px] pb-5 relative transition-all duration-200 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:-translate-y-0.5">
          <div className="text-[10px] font-bold tracking-[.1em] text-[#686BAB] mb-[10px]">
            02. OPTIMIZE
          </div>
          ...
          <ul className="flex flex-col gap-2">
            {[
              ...
              <li
                ...
                className="flex items-center gap-2 text-[13px] text-[#686B6B]"
              >
                <span className="w-[18px] h-[18px] rounded-full flex items-center justify-center shrink-0 text-[10px] bg-[#EEEEF6] text-[#686BAB]">
                  ✓
                </span>
                {item}
              </li>
        ...
        <div className="bg-white border border-[#E6E4DF] rounded-[18px] pt-6 px-[22px] pb-5 relative transition-all duration-200 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 sm:col-span-2 lg:col-span-1">
          <div className="text-[10px] font-bold tracking-[.1em] text-[#16a34a] mb-[10px]">
            03. AUTOMATE
          </div>
          ...
          <ul className="flex flex-col gap-2">
            {[
              ...
              <li
                ...
                className="flex items-center gap-2 text-[13px] text-[#686B6B]"
              >
                <span className="w-[18px] h-[18px] rounded-full flex items-center justify-center shrink-0 text-[10px] bg-[#d1fae5] text-[#16a34a]">
                  ✓
                </span>
                {item}
              </li>
      ...
      <div className="bg-white border border-[#E6E4DF] rounded-[18px] px-4 sm:px-6 py-5 mt-5">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-[10px]">
          ...
          <span className="hidden sm:block text-[#686B6B] text-base shrink-0">
            →
          </span>
          <div
          ...
          >
            ...
            <div className="flex gap-2 flex-wrap">
              {[
                ...
                <div
                  key={label}
                  className="flex items-center gap-[5px] text-[11px] font-medium text-white/80 whitespace-nowrap"
                >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto_1fr] mt-5 rounded-[18px] overflow-hidden border border-[#E6E4DF]">
        <div className="bg-white px-6 py-[22px] border-b sm:border-b-0 sm:border-r border-[#E6E4DF]">
          <div className="text-[10px] font-bold tracking-[.1em] text-[#ef4444] mb-[6px]">
            TRADITIONAL AGENCY
          </div>
          <div className="font-heading text-[28px] font-bold leading-none text-[#1A1A1A]">
            3 Months+
          </div>
          <div className="text-[13px] font-semibold text-[#686B6B] mt-0.5 mb-[14px]">
            To Launch
          </div>
          <ul className="flex flex-col gap-[7px]">
            {[
              ...
              <li
                key={item}
                className="text-[12.5px] text-[#686B6B] flex items-center gap-[6px]"
              >
        ...
        <div className="bg-[#F7F6F3] flex items-center justify-center px-5 py-3 sm:py-0 font-heading text-lg font-bold text-[#686B6B] border-b sm:border-b-0 sm:border-r border-[#E6E4DF]">
          VS
        </div>
        <div className="bg-[#F7F6F3] px-6 py-[22px] flex gap-5 items-center">
          <div className="flex-1">
            <div className="text-[10px] font-bold tracking-[.1em] text-[#16a34a] mb-[6px]">
              ZONNETECH (AI-POWERED)
            </div>
            <div className="font-heading text-[28px] font-bold leading-none text-[#16a34a]">
              30 Days
            </div>
            <div className="text-[13px] font-semibold text-[#686B6B] mt-0.5 mb-[14px]">
              To Launch
      ...
      <div className="mt-5 flex flex-col sm:flex-row sm:items-center bg-white border border-[#E6E4DF] rounded-[18px] px-4 sm:px-6 py-[18px] gap-5 sm:gap-0">
        <div className="flex items-start gap-[14px] sm:flex-[1.2] sm:border-r border-[#E6E4DF] sm:pr-6 sm:mr-6 pb-5 sm:pb-0 border-b sm:border-b-0">
          ...
          <p className="text-[12.5px] text-[#686B6B] leading-[1.6]">
            We use AI to compress development timelines without compromising
            quality.
            <br />
            <strong className="text-[#1A1A1A] font-bold">
              What takes others 3 months, takes us 30 days.
            </strong>
          </p>
        </div>
        <div className="grid grid-cols-3 gap-4 sm:flex-[2] sm:flex sm:gap-8">
          {[
            ...
            },
            {
              icon: "∞",
              title: "Future Ready",
              sub: "Scalable & Flexible",
              green: true,
            },
          ].map(({ icon, title, sub, green }) => (
            <div key={title} className="flex items-start gap-[10px]">
              <span
                className={`text-xl shrink-0 ${green ? "text-[#16a34a]" : "text-[#1A1A1A]"}`}
              >
                {icon}
              </span>
              <div>
                <h4 className="text-[12px] sm:text-[13px] font-bold text-[#1A1A1A]">
                  {title}
                </h4>
                <p className="text-[11px] sm:text-[11.5px] text-[#686B6B] mt-px">
                  {sub}
                </p>
              </div>
            </div>
