...
export const caseStudies = [
  {
    ...
    description: [
      ...
      { text: ' that tracks prices of your favourite products across 20 crore products.' },
    ],
    stats: [
  ...
  },
  {
    ...
    name: 'Hyyzo',
    tagline: "India's Highest Cashback Paying Platform",
    photo: '/images/zonet/hyyzo-1.png',
    badge: 'FinTech',
    description: [
      { text: "Created India's " },
      { text: 'highest-paying cashback rewards engine', highlight: true },
  ...
  },
  {
    ...
    name: 'TeacherDekho',
    tagline: 'Verified Mentor Finding Marketplace',
    photo: '/images/zonet/teacherdekho-1.png',
    badge: 'Ed-Tech',
    description: [
      { text: 'Launched a ' },
      { text: 'verified mentor & student marketplace', highlight: true },
      { text: ' connecting them with AI-powered progress tracking.' },
    ],
    stats: [
  ...
  },
  {
    ...
    name: 'KaiseKare',
    tagline: 'The Digital Trivia and Contest Platform',
    ...
    stats: [
      { value: '3x', label: 'Lead Growth', icon: 'TrendingUp' },
    ...
    detail: {
      ...
      tech: ['Next.js', 'Sanity CMS', 'Tailwind CSS', 'Motion'],
      features: [
  ...
  },
  {
    ...
    tagline: 'Smooth Ad-Free Viewing Experience',
    photo: '/images/zonet/screenshot-3.png',
    badge: 'Extension',
    description: [
      { text: 'Created a ' },
      { text: 'robust ad-blocking extension', highlight: true },
      { text: ' providing a seamless viewing experience with a 4.9 rating.' },
    ],
    stats: [
      { value: '1M+', label: 'Installs', icon: 'TrendingUp' },
      { value: '4.9★', label: 'Rating', icon: 'Star' },
      { value: '0', label: 'Ads Shown', icon: 'Users' },
    ],
    detail: {
  ...
  },
  {
    ...
    name: 'HyyFam',
    tagline: 'Social Media Earning Platform',
    photo: '/images/zonet/screenshot-5.png',
    badge: 'Social',
    description: [
      { text: 'Created a ' },
      { text: 'vibrant social media rewarding app', highlight: true },
      { text: ' for influencer community engagement with 10M+ posts.' },
    ],
    stats: [
  ...
  },
  {
    ...
    name: 'The Best Deal App',
    tagline: 'Right Spot to Find Deals',
    ...
    detail: {
      ...
      tech: ['Next.js', 'PyScript (AI logic)', 'Redis', 'Node.js'],
      features: [
  ...
  },
  {
    ...
    name: 'Hyzify',
    tagline: 'Smartest Affiliate Website',
    photo: '/images/zonet/screenshot-1.png',
    badge: 'FinTech',
    description: [
      { text: 'Developed a ' },
      { text: 'secure FinTech solution', highlight: true },
      { text: ' for seamless financial transactions with bank-grade security.' },
    ],
    stats: [
    ...
    detail: {
      ...
      tech: ['Go', 'Rust (crypto ops)', 'PostgreSQL', 'AI Smart-Router'],
      features: [
